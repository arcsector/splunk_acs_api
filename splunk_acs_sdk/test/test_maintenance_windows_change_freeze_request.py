...
from openapi_client.models.maintenance_windows_change_freeze_request import MaintenanceWindowsChangeFreezeRequest

class TestMaintenanceWindowsChangeFreezeRequest(unittest.TestCase):
    """MaintenanceWindowsChangeFreezeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowsChangeFreezeRequest:
        """Test MaintenanceWindowsChangeFreezeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowsChangeFreezeRequest`
        """
        model = MaintenanceWindowsChangeFreezeRequest()
        if include_optional:
            return MaintenanceWindowsChangeFreezeRequest(
    ...
    def testMaintenanceWindowsChangeFreezeRequest(self):
        """Test MaintenanceWindowsChangeFreezeRequest"""
