...
from openapi_client.models.maintenance_windows_preferences_request import MaintenanceWindowsPreferencesRequest

class TestMaintenanceWindowsPreferencesRequest(unittest.TestCase):
    """MaintenanceWindowsPreferencesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowsPreferencesRequest:
        """Test MaintenanceWindowsPreferencesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowsPreferencesRequest`
        """
        model = MaintenanceWindowsPreferencesRequest()
        if include_optional:
            return MaintenanceWindowsPreferencesRequest(
                change_freezes = openapi_client.models.maintenance_windows_change_freeze_request.MaintenanceWindowsChangeFreezeRequest(
                    customer_initiated_freezes = [
                        openapi_client.models.maintenance_windows_customer_initiated_freeze_request.MaintenanceWindowsCustomerInitiatedFreezeRequest(
    ...
    def testMaintenanceWindowsPreferencesRequest(self):
        """Test MaintenanceWindowsPreferencesRequest"""
