...
from openapi_client.models.app_perms import AppPerms

class TestAppPerms(unittest.TestCase):
    """AppPerms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPerms:
        """Test AppPerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPerms`
        """
        model = AppPerms()
        if include_optional:
            return AppPerms(
