...
from openapi_client.models.self_storage_location_prefix import SelfStorageLocationPrefix

class TestSelfStorageLocationPrefix(unittest.TestCase):
    """SelfStorageLocationPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfStorageLocationPrefix:
        """Test SelfStorageLocationPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelfStorageLocationPrefix`
        """
        model = SelfStorageLocationPrefix()
        if include_optional:
            return SelfStorageLocationPrefix(
                message = '',
                prefix = ''
            )
        else:
    ...
    def testSelfStorageLocationPrefix(self):
        """Test SelfStorageLocationPrefix"""
