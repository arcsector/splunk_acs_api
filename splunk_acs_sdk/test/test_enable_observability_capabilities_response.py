...
from openapi_client.models.enable_observability_capabilities_response import EnableObservabilityCapabilitiesResponse

class TestEnableObservabilityCapabilitiesResponse(unittest.TestCase):
    """EnableObservabilityCapabilitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnableObservabilityCapabilitiesResponse:
        """Test EnableObservabilityCapabilitiesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnableObservabilityCapabilitiesResponse`
        """
        model = EnableObservabilityCapabilitiesResponse()
        if include_optional:
            return EnableObservabilityCapabilitiesResponse(
                centralized_rbac_enabled = True
            )
        else:
            return EnableObservabilityCapabilitiesResponse(
        )
    ...
    def testEnableObservabilityCapabilitiesResponse(self):
        """Test EnableObservabilityCapabilitiesResponse"""
