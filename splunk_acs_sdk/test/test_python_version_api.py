...
from openapi_client.api.python_version_api import PythonVersionApi


class TestPythonVersionApi(unittest.TestCase):
    """PythonVersionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PythonVersionApi()

    def tearDown(self) -> None:
        pass

    def test_change_python_version(self) -> None:
        """Test case for change_python_version
