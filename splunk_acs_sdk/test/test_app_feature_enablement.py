...
from openapi_client.models.app_feature_enablement import AppFeatureEnablement

class TestAppFeatureEnablement(unittest.TestCase):
    """AppFeatureEnablement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppFeatureEnablement:
        """Test AppFeatureEnablement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppFeatureEnablement`
        """
        model = AppFeatureEnablement()
        if include_optional:
            return AppFeatureEnablement(
                enabled = True
            )
        else:
            return AppFeatureEnablement(
    ...
    def testAppFeatureEnablement(self):
        """Test AppFeatureEnablement"""
