...
from openapi_client.models.maintenance_windows_splunk_initiated_freeze_response import MaintenanceWindowsSplunkInitiatedFreezeResponse

class TestMaintenanceWindowsSplunkInitiatedFreezeResponse(unittest.TestCase):
    """MaintenanceWindowsSplunkInitiatedFreezeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowsSplunkInitiatedFreezeResponse:
        """Test MaintenanceWindowsSplunkInitiatedFreezeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowsSplunkInitiatedFreezeResponse`
        """
        model = MaintenanceWindowsSplunkInitiatedFreezeResponse()
        if include_optional:
            return MaintenanceWindowsSplunkInitiatedFreezeResponse(
    ...
    def testMaintenanceWindowsSplunkInitiatedFreezeResponse(self):
        """Test MaintenanceWindowsSplunkInitiatedFreezeResponse"""
