...
from openapi_client.models.create_ec_sso_pairing_response import CreateEcSsoPairingResponse

class TestCreateEcSsoPairingResponse(unittest.TestCase):
    """CreateEcSsoPairingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEcSsoPairingResponse:
        """Test CreateEcSsoPairingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateEcSsoPairingResponse`
        """
        model = CreateEcSsoPairingResponse()
        if include_optional:
            return CreateEcSsoPairingResponse(
                pairing_id = ''
            )
        else:
            return CreateEcSsoPairingResponse(
    ...
    def testCreateEcSsoPairingResponse(self):
        """Test CreateEcSsoPairingResponse"""
