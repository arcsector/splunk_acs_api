...
from openapi_client.models.stack_status_messages import StackStatusMessages

class TestStackStatusMessages(unittest.TestCase):
    """StackStatusMessages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StackStatusMessages:
        """Test StackStatusMessages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StackStatusMessages`
        """
        model = StackStatusMessages()
        if include_optional:
            return StackStatusMessages(
    ...
    def testStackStatusMessages(self):
        """Test StackStatusMessages"""
