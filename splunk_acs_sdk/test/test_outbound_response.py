...
from openapi_client.models.outbound_response import OutboundResponse
...
class TestOutboundResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OutboundResponse:
        """Test OutboundResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutboundResponse`
        """
