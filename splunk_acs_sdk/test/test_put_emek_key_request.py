...
from openapi_client.models.put_emek_key_request import PutEmekKeyRequest

class TestPutEmekKeyRequest(unittest.TestCase):
    """PutEmekKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutEmekKeyRequest:
        """Test PutEmekKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutEmekKeyRequest`
        """
        model = PutEmekKeyRequest()
        if include_optional:
            return PutEmekKeyRequest(
                key_arn = ''
            )
        else:
            return PutEmekKeyRequest(
    ...
    def testPutEmekKeyRequest(self):
        """Test PutEmekKeyRequest"""
