...
from openapi_client.models.self_storage_location_body import SelfStorageLocationBody

class TestSelfStorageLocationBody(unittest.TestCase):
    """SelfStorageLocationBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfStorageLocationBody:
        """Test SelfStorageLocationBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelfStorageLocationBody`
        """
        model = SelfStorageLocationBody()
        if include_optional:
            return SelfStorageLocationBody(
                bucket_name = '',
                description = '',
                folder = '',
                title = ''
    ...
    def testSelfStorageLocationBody(self):
        """Test SelfStorageLocationBody"""
