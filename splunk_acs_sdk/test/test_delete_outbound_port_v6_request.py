...
class TestDeleteOutboundPortV6Request(unittest.TestCase):
    """DeleteOutboundPortV6Request unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteOutboundPortV6Request:
        """Test DeleteOutboundPortV6Request
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteOutboundPortV6Request`
        """
        model = DeleteOutboundPortV6Request()
        if include_optional:
            return DeleteOutboundPortV6Request(
                subnets = [
                    ''
                    ]
            )
    ...
    def testDeleteOutboundPortV6Request(self):
        """Test DeleteOutboundPortV6Request"""
