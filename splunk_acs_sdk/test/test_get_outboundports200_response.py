...
from openapi_client.models.get_outboundports200_response import GetOutboundports200Response

class TestGetOutboundports200Response(unittest.TestCase):
    """GetOutboundports200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOutboundports200Response:
        """Test GetOutboundports200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOutboundports200Response`
        """
        model = GetOutboundports200Response()
        if include_optional:
            return GetOutboundports200Response(
                outboundports = [
                    openapi_client.models.outbound_response.OutboundResponse(
                        destination_ranges = [
                            ''
                            ], 
                        name = '', 
    ...
    def testGetOutboundports200Response(self):
        """Test GetOutboundports200Response"""
