...
from openapi_client.models.add_subnets_request import AddSubnetsRequest

class TestAddSubnetsRequest(unittest.TestCase):
    """AddSubnetsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddSubnetsRequest:
        """Test AddSubnetsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddSubnetsRequest`
        """
        model = AddSubnetsRequest()
        if include_optional:
            return AddSubnetsRequest(
                subnets = [
                    ''
                    ]
            )
    ...
    def testAddSubnetsRequest(self):
        """Test AddSubnetsRequest"""
