...
from openapi_client.api.private_connectivity_api import PrivateConnectivityApi


class TestPrivateConnectivityApi(unittest.TestCase):
    """PrivateConnectivityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PrivateConnectivityApi()
