...
from openapi_client.models.self_storage_location_service_accounts import SelfStorageLocationServiceAccounts

class TestSelfStorageLocationServiceAccounts(unittest.TestCase):
    """SelfStorageLocationServiceAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfStorageLocationServiceAccounts:
        """Test SelfStorageLocationServiceAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelfStorageLocationServiceAccounts`
        """
        model = SelfStorageLocationServiceAccounts()
        if include_optional:
            return SelfStorageLocationServiceAccounts(
                cluster_master = '',
                indexer = ''
            )
        else:
    ...
    def testSelfStorageLocationServiceAccounts(self):
        """Test SelfStorageLocationServiceAccounts"""
