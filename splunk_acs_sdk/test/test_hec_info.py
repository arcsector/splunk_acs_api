...
from openapi_client.models.hec_info import HecInfo

class TestHecInfo(unittest.TestCase):
    """HecInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HecInfo:
        """Test HecInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HecInfo`
        """
        model = HecInfo()
        if include_optional:
            return HecInfo(
