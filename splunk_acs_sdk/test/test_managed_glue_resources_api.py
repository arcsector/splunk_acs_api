...
from openapi_client.api.managed_glue_resources_api import ManagedGlueResourcesApi


class TestManagedGlueResourcesApi(unittest.TestCase):
    """ManagedGlueResourcesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ManagedGlueResourcesApi()

    def tearDown(self) -> None:
        pass

    def test_describe_managed_glue_resources(self) -> None:
        """Test case for describe_managed_glue_resources

        """
        pass

    def test_update_managed_glue_resources(self) -> None:
        """Test case for update_managed_glue_resources
