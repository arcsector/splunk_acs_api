...
from openapi_client.models.limit_setting import LimitSetting

class TestLimitSetting(unittest.TestCase):
    """LimitSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitSetting:
        """Test LimitSetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitSetting`
        """
        model = LimitSetting()
        if include_optional:
            return LimitSetting(
