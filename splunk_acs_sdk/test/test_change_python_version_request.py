...
from openapi_client.models.change_python_version_request import ChangePythonVersionRequest

class TestChangePythonVersionRequest(unittest.TestCase):
    """ChangePythonVersionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangePythonVersionRequest:
        """Test ChangePythonVersionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangePythonVersionRequest`
        """
        model = ChangePythonVersionRequest()
        if include_optional:
            return ChangePythonVersionRequest(
                python_version = ''
            )
        else:
            return ChangePythonVersionRequest(
    ...
    def testChangePythonVersionRequest(self):
        """Test ChangePythonVersionRequest"""
