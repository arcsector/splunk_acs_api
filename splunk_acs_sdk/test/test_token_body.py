...
from openapi_client.models.token_body import TokenBody
...
class TestTokenBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TokenBody:
        """Test TokenBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenBody`
        """
        model = TokenBody()
        if include_optional:
            return TokenBody(
