...
from openapi_client.models.retry_deployment200_response import RetryDeployment200Response

class TestRetryDeployment200Response(unittest.TestCase):
    """RetryDeployment200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetryDeployment200Response:
        """Test RetryDeployment200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetryDeployment200Response`
        """
        model = RetryDeployment200Response()
        if include_optional:
            return RetryDeployment200Response(
                status = openapi_client.models.deployment_info.DeploymentInfo(
                    id = '', 
                    status = '', 
                    timestamp = '', )
            )
    ...
    def testRetryDeployment200Response(self):
        """Test RetryDeployment200Response"""
