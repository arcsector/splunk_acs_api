...
from openapi_client.models.maintenance_windows_customer_initiated_freeze_request import MaintenanceWindowsCustomerInitiatedFreezeRequest

class TestMaintenanceWindowsCustomerInitiatedFreezeRequest(unittest.TestCase):
    """MaintenanceWindowsCustomerInitiatedFreezeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowsCustomerInitiatedFreezeRequest:
        """Test MaintenanceWindowsCustomerInitiatedFreezeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowsCustomerInitiatedFreezeRequest`
        """
        model = MaintenanceWindowsCustomerInitiatedFreezeRequest()
        if include_optional:
            return MaintenanceWindowsCustomerInitiatedFreezeRequest(
    ...
    def testMaintenanceWindowsCustomerInitiatedFreezeRequest(self):
        """Test MaintenanceWindowsCustomerInitiatedFreezeRequest"""
