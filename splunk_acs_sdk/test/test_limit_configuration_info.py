...
from openapi_client.models.limit_configuration_info import LimitConfigurationInfo

class TestLimitConfigurationInfo(unittest.TestCase):
    """LimitConfigurationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitConfigurationInfo:
        """Test LimitConfigurationInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitConfigurationInfo`
        """
        model = LimitConfigurationInfo()
        if include_optional:
            return LimitConfigurationInfo(
                settings = None
            )
        else:
            return LimitConfigurationInfo(
    ...
    def testLimitConfigurationInfo(self):
        """Test LimitConfigurationInfo"""
