...
from openapi_client.models.python_version_response import PythonVersionResponse

class TestPythonVersionResponse(unittest.TestCase):
    """PythonVersionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PythonVersionResponse:
        """Test PythonVersionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PythonVersionResponse`
        """
        model = PythonVersionResponse()
        if include_optional:
            return PythonVersionResponse(
                message = '',
                python_version = ''
            )
        else:
    ...
    def testPythonVersionResponse(self):
        """Test PythonVersionResponse"""
