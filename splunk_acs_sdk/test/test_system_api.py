...
class TestSystemApi(unittest.TestCase):
    ...
    def test_describe_deployment(self) -> None:
        """Test case for describe_deployment

        """
        pass

    def test_describe_stack(self) -> None:
        """Test case for describe_stack

        """
        pass

    def test_list_deployment(self) -> None:
        """Test case for list_deployment

        """
        pass

    def test_retry_deployment(self) -> None:
        """Test case for retry_deployment
