...
from openapi_client.models.app_perms_list import AppPermsList

class TestAppPermsList(unittest.TestCase):
    """AppPermsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPermsList:
        """Test AppPermsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPermsList`
        """
        model = AppPermsList()
        if include_optional:
            return AppPermsList(
