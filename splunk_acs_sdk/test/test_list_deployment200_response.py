...
from openapi_client.models.list_deployment200_response import ListDeployment200Response

class TestListDeployment200Response(unittest.TestCase):
    """ListDeployment200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDeployment200Response:
        """Test ListDeployment200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDeployment200Response`
        """
        model = ListDeployment200Response()
        if include_optional:
            return ListDeployment200Response(
                status = openapi_client.models.deployment_status.DeploymentStatus(
                    last_deployment = openapi_client.models.deployment_info.DeploymentInfo(
                        id = '', 
                        status = '', 
                        timestamp = '', ), )
            )
    ...
    def testListDeployment200Response(self):
        """Test ListDeployment200Response"""
