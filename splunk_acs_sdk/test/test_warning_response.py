...
from openapi_client.models.warning_response import WarningResponse

class TestWarningResponse(unittest.TestCase):
    """WarningResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WarningResponse:
        """Test WarningResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WarningResponse`
        """
