...
from openapi_client.models.limit_configuration_response import LimitConfigurationResponse

class TestLimitConfigurationResponse(unittest.TestCase):
    """LimitConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitConfigurationResponse:
        """Test LimitConfigurationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitConfigurationResponse`
        """
        model = LimitConfigurationResponse()
        if include_optional:
            return LimitConfigurationResponse(
                settings = [
                    ''
                    ]
            )
    ...
    def testLimitConfigurationResponse(self):
        """Test LimitConfigurationResponse"""
