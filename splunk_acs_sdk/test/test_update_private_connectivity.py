...
from openapi_client.models.update_private_connectivity import UpdatePrivateConnectivity

class TestUpdatePrivateConnectivity(unittest.TestCase):
    """UpdatePrivateConnectivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePrivateConnectivity:
        """Test UpdatePrivateConnectivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePrivateConnectivity`
        """
        model = UpdatePrivateConnectivity()
        if include_optional:
            return UpdatePrivateConnectivity(
                feature = [
                    'ingest'
                    ],
                patched_customer_account_ids = [
                    ''
                    ]
            )
        else:
    ...
    def testUpdatePrivateConnectivity(self):
        """Test UpdatePrivateConnectivity"""
