...
from openapi_client.models.emek_key_upload_response import EmekKeyUploadResponse

class TestEmekKeyUploadResponse(unittest.TestCase):
    """EmekKeyUploadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmekKeyUploadResponse:
        """Test EmekKeyUploadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmekKeyUploadResponse`
        """
        model = EmekKeyUploadResponse()
        if include_optional:
            return EmekKeyUploadResponse(
                message = ''
            )
        else:
            return EmekKeyUploadResponse(
    ...
    def testEmekKeyUploadResponse(self):
        """Test EmekKeyUploadResponse"""
