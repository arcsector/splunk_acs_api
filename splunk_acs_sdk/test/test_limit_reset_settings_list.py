...
from openapi_client.models.limit_reset_settings_list import LimitResetSettingsList

class TestLimitResetSettingsList(unittest.TestCase):
    """LimitResetSettingsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitResetSettingsList:
        """Test LimitResetSettingsList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitResetSettingsList`
        """
        model = LimitResetSettingsList()
        if include_optional:
            return LimitResetSettingsList(
                settings = [
                    ''
                    ]
            )
    ...
    def testLimitResetSettingsList(self):
        """Test LimitResetSettingsList"""
