...
from openapi_client.models.asl_provider_properties import AslProviderProperties

class TestAslProviderProperties(unittest.TestCase):
    """AslProviderProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AslProviderProperties:
        """Test AslProviderProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AslProviderProperties`
        """
        model = AslProviderProperties()
        if include_optional:
            return AslProviderProperties(
                local_database = '',
                remote_database = '',
                remote_tables = [
                    ''
    ...
    def testAslProviderProperties(self):
        """Test AslProviderProperties"""
