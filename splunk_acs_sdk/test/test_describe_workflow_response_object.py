...
from openapi_client.models.describe_workflow_response_object import DescribeWorkflowResponseObject

class TestDescribeWorkflowResponseObject(unittest.TestCase):
    """DescribeWorkflowResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeWorkflowResponseObject:
        """Test DescribeWorkflowResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeWorkflowResponseObject`
        """
        model = DescribeWorkflowResponseObject()
        if include_optional:
            return DescribeWorkflowResponseObject(
                created_at = '',
                finished_at = '',
                name = '',
                started_at = '',
    ...
    def testDescribeWorkflowResponseObject(self):
        """Test DescribeWorkflowResponseObject"""
