...
from openapi_client.models.restart_response import RestartResponse

class TestRestartResponse(unittest.TestCase):
    """RestartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestartResponse:
        """Test RestartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestartResponse`
        """
        model = RestartResponse()
        if include_optional:
