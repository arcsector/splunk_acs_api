...
from openapi_client.models.describe_eligibility_private_connectivity import DescribeEligibilityPrivateConnectivity

class TestDescribeEligibilityPrivateConnectivity(unittest.TestCase):
    """DescribeEligibilityPrivateConnectivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeEligibilityPrivateConnectivity:
        """Test DescribeEligibilityPrivateConnectivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeEligibilityPrivateConnectivity`
        """
        model = DescribeEligibilityPrivateConnectivity()
        if include_optional:
            return DescribeEligibilityPrivateConnectivity(
                eligible = True,
                reason = ''
            )
        else:
    ...
    def testDescribeEligibilityPrivateConnectivity(self):
        """Test DescribeEligibilityPrivateConnectivity"""
