...
from openapi_client.models.capabilities_info import CapabilitiesInfo

class TestCapabilitiesInfo(unittest.TestCase):
    """CapabilitiesInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapabilitiesInfo:
        """Test CapabilitiesInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapabilitiesInfo`
        """
        model = CapabilitiesInfo()
        if include_optional:
