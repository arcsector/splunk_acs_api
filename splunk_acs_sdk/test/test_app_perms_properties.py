...
from openapi_client.models.app_perms_properties import AppPermsProperties

class TestAppPermsProperties(unittest.TestCase):
    """AppPermsProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppPermsProperties:
        """Test AppPermsProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppPermsProperties`
        """
        model = AppPermsProperties()
        if include_optional:
            return AppPermsProperties(
                read = [
                    ''
                    ],
                write = [
    ...
    def testAppPermsProperties(self):
        """Test AppPermsProperties"""
