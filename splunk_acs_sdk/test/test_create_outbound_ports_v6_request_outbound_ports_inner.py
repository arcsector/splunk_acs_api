...
class TestCreateOutboundPortsV6RequestOutboundPortsInner(unittest.TestCase):
    """CreateOutboundPortsV6RequestOutboundPortsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOutboundPortsV6RequestOutboundPortsInner:
        """Test CreateOutboundPortsV6RequestOutboundPortsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOutboundPortsV6RequestOutboundPortsInner`
        """
        model = CreateOutboundPortsV6RequestOutboundPortsInner()
        if include_optional:
            return CreateOutboundPortsV6RequestOutboundPortsInner(
                port = 56,
                subnets = [
                    ''
                    ]
    ...
    def testCreateOutboundPortsV6RequestOutboundPortsInner(self):
        """Test CreateOutboundPortsV6RequestOutboundPortsInner"""
