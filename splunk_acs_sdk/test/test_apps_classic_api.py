...
from openapi_client.api.apps_classic_api import AppsClassicApi


class TestAppsClassicApi(unittest.TestCase):
    """AppsClassicApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AppsClassicApi()

    def tearDown(self) -> None:
        pass

    def test_patch_app_classic(self) -> None:
        """Test case for patch_app_classic
