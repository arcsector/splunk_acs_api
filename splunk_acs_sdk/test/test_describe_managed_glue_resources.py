...
from openapi_client.models.describe_managed_glue_resources import DescribeManagedGlueResources

class TestDescribeManagedGlueResources(unittest.TestCase):
    """DescribeManagedGlueResources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeManagedGlueResources:
        """Test DescribeManagedGlueResources
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeManagedGlueResources`
        """
        model = DescribeManagedGlueResources()
        if include_optional:
            return DescribeManagedGlueResources(
    ...
    def testDescribeManagedGlueResources(self):
        """Test DescribeManagedGlueResources"""
