...
from openapi_client.models.patch_index_info import PatchIndexInfo

class TestPatchIndexInfo(unittest.TestCase):
    """PatchIndexInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchIndexInfo:
        """Test PatchIndexInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchIndexInfo`
        """
        model = PatchIndexInfo()
        if include_optional:
            return PatchIndexInfo(
                max_data_size_mb = 56,
                searchable_days = 56,
