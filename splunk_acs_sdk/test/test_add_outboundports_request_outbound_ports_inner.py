...
from openapi_client.models.add_outboundports_request_outbound_ports_inner import AddOutboundportsRequestOutboundPortsInner

class TestAddOutboundportsRequestOutboundPortsInner(unittest.TestCase):
    """AddOutboundportsRequestOutboundPortsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOutboundportsRequestOutboundPortsInner:
        """Test AddOutboundportsRequestOutboundPortsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOutboundportsRequestOutboundPortsInner`
        """
        model = AddOutboundportsRequestOutboundPortsInner()
        if include_optional:
            return AddOutboundportsRequestOutboundPortsInner(
                port = 56,
                subnets = [
                    ''
                    ]
    ...
    def testAddOutboundportsRequestOutboundPortsInner(self):
        """Test AddOutboundportsRequestOutboundPortsInner"""
