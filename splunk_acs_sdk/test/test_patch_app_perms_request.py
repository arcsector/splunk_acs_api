...
from openapi_client.models.patch_app_perms_request import PatchAppPermsRequest

class TestPatchAppPermsRequest(unittest.TestCase):
    """PatchAppPermsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchAppPermsRequest:
        """Test PatchAppPermsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchAppPermsRequest`
        """
        model = PatchAppPermsRequest()
        if include_optional:
            return PatchAppPermsRequest(
                read = [
                    ''
                    ],
                write = [
    ...
    def testPatchAppPermsRequest(self):
        """Test PatchAppPermsRequest"""
