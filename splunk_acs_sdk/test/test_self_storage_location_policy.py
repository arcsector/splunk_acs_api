...
from openapi_client.models.self_storage_location_policy import SelfStorageLocationPolicy

class TestSelfStorageLocationPolicy(unittest.TestCase):
    """SelfStorageLocationPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfStorageLocationPolicy:
        """Test SelfStorageLocationPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelfStorageLocationPolicy`
        """
        model = SelfStorageLocationPolicy()
        if include_optional:
            return SelfStorageLocationPolicy(
                message = '',
                policy = None
            )
        else:
    ...
    def testSelfStorageLocationPolicy(self):
        """Test SelfStorageLocationPolicy"""
