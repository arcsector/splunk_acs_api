...
from openapi_client.models.stack_status import StackStatus

class TestStackStatus(unittest.TestCase):
    """StackStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StackStatus:
        """Test StackStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StackStatus`
        """
        model = StackStatus()
        if include_optional:
            return StackStatus(
