...
from openapi_client.models.maintenance_windows_schedule import MaintenanceWindowsSchedule

class TestMaintenanceWindowsSchedule(unittest.TestCase):
    """MaintenanceWindowsSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowsSchedule:
        """Test MaintenanceWindowsSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowsSchedule`
        """
        model = MaintenanceWindowsSchedule()
        if include_optional:
            return MaintenanceWindowsSchedule(
                duration = '',
    ...
    def testMaintenanceWindowsSchedule(self):
        """Test MaintenanceWindowsSchedule"""
