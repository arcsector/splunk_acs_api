...
from openapi_client.models.self_storage_location_info import SelfStorageLocationInfo

class TestSelfStorageLocationInfo(unittest.TestCase):
    """SelfStorageLocationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfStorageLocationInfo:
        """Test SelfStorageLocationInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelfStorageLocationInfo`
        """
        model = SelfStorageLocationInfo()
        if include_optional:
            return SelfStorageLocationInfo(
                bucket_name = '',
                bucket_path = '',
                description = '',
                folder = '',
    ...
    def testSelfStorageLocationInfo(self):
        """Test SelfStorageLocationInfo"""
