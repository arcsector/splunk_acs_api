...
from openapi_client.models.self_storage_location_service_accounts_response import SelfStorageLocationServiceAccountsResponse

class TestSelfStorageLocationServiceAccountsResponse(unittest.TestCase):
    """SelfStorageLocationServiceAccountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelfStorageLocationServiceAccountsResponse:
        """Test SelfStorageLocationServiceAccountsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelfStorageLocationServiceAccountsResponse`
        """
        model = SelfStorageLocationServiceAccountsResponse()
        if include_optional:
            return SelfStorageLocationServiceAccountsResponse(
                message = '',
                service_accounts = openapi_client.models.self_storage_location_service_accounts.SelfStorageLocationServiceAccounts(
                    cluster_master = '', 
                    indexer = '', )
            )
        else:
    ...
    def testSelfStorageLocationServiceAccountsResponse(self):
        """Test SelfStorageLocationServiceAccountsResponse"""
