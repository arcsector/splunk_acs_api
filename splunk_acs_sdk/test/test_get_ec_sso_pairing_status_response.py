...
from openapi_client.models.get_ec_sso_pairing_status_response import GetEcSsoPairingStatusResponse

class TestGetEcSsoPairingStatusResponse(unittest.TestCase):
    """GetEcSsoPairingStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEcSsoPairingStatusResponse:
        """Test GetEcSsoPairingStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEcSsoPairingStatusResponse`
        """
        model = GetEcSsoPairingStatusResponse()
        if include_optional:
            return GetEcSsoPairingStatusResponse(
                pairing_id = '',
                status = ''
            )
        else:
    ...
    def testGetEcSsoPairingStatusResponse(self):
        """Test GetEcSsoPairingStatusResponse"""
