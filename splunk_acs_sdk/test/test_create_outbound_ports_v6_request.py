...
class TestCreateOutboundPortsV6Request(unittest.TestCase):
    """CreateOutboundPortsV6Request unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOutboundPortsV6Request:
        """Test CreateOutboundPortsV6Request
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOutboundPortsV6Request`
        """
        model = CreateOutboundPortsV6Request()
        if include_optional:
            return CreateOutboundPortsV6Request(
                outbound_ports = [
                    splunk_acs_sdk.models.create_outbound_ports_v6_request_outbound_ports_inner.CreateOutboundPortsV6_request_outboundPorts_inner(
                        port = 56, 
                        subnets = [
                            ''
                            ], )
    ...
    def testCreateOutboundPortsV6Request(self):
        """Test CreateOutboundPortsV6Request"""
