...
from openapi_client.models.list_self_storage_locations200_response import ListSelfStorageLocations200Response

class TestListSelfStorageLocations200Response(unittest.TestCase):
    """ListSelfStorageLocations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListSelfStorageLocations200Response:
        """Test ListSelfStorageLocations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSelfStorageLocations200Response`
        """
        model = ListSelfStorageLocations200Response()
        if include_optional:
            return ListSelfStorageLocations200Response(
                self_storage_locations = [
                    openapi_client.models.self_storage_location_info.SelfStorageLocationInfo(
                        bucket_name = '', 
                        bucket_path = '', 
                        description = '', 
                        folder = '', 
    ...
    def testListSelfStorageLocations200Response(self):
        """Test ListSelfStorageLocations200Response"""
