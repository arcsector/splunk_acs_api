...
from openapi_client.models.list_permissions_apps200_response import ListPermissionsApps200Response

class TestListPermissionsApps200Response(unittest.TestCase):
    """ListPermissionsApps200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPermissionsApps200Response:
        """Test ListPermissionsApps200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPermissionsApps200Response`
        """
        model = ListPermissionsApps200Response()
        if include_optional:
            return ListPermissionsApps200Response(
                tokeninfo = openapi_client.models.app_perms_list.AppPermsList(
                    apps = [
                        openapi_client.models.app_perms.AppPerms(
                            name = '', 
                            perms = openapi_client.models.app_perms_properties.AppPermsProperties(
                                read = [
                                    ''
                                    ], 
                                write = [
    ...
    def testListPermissionsApps200Response(self):
        """Test ListPermissionsApps200Response"""
