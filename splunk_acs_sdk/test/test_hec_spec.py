...
from openapi_client.models.hec_spec import HecSpec

class TestHecSpec(unittest.TestCase):
    """HecSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HecSpec:
        """Test HecSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HecSpec`
        """
        model = HecSpec()
        if include_optional:
            return HecSpec(
