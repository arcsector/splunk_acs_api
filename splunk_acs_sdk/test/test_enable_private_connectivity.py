...
from openapi_client.models.enable_private_connectivity import EnablePrivateConnectivity

class TestEnablePrivateConnectivity(unittest.TestCase):
    """EnablePrivateConnectivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnablePrivateConnectivity:
        """Test EnablePrivateConnectivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnablePrivateConnectivity`
        """
        model = EnablePrivateConnectivity()
        if include_optional:
            return EnablePrivateConnectivity(
    ...
    def testEnablePrivateConnectivity(self):
        """Test EnablePrivateConnectivity"""
