...
from openapi_client.models.imported_roles_info import ImportedRolesInfo

class TestImportedRolesInfo(unittest.TestCase):
    """ImportedRolesInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportedRolesInfo:
        """Test ImportedRolesInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportedRolesInfo`
        """
        model = ImportedRolesInfo()
        if include_optional:
            return ImportedRolesInfo(
                capabilities = [
                    ''
                    ],
                rt_srch_jobs_quota = 56,
                srch_disk_quota = 56,
                srch_filter = '',
    ...
    def testImportedRolesInfo(self):
        """Test ImportedRolesInfo"""
