...
from openapi_client.api.cloud_resources_api import CloudResourcesApi


class TestCloudResourcesApi(unittest.TestCase):
    """CloudResourcesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CloudResourcesApi()
