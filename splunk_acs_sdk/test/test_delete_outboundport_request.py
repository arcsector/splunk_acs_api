...
from openapi_client.models.delete_outboundport_request import DeleteOutboundportRequest

class TestDeleteOutboundportRequest(unittest.TestCase):
    """DeleteOutboundportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteOutboundportRequest:
        """Test DeleteOutboundportRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteOutboundportRequest`
        """
        model = DeleteOutboundportRequest()
        if include_optional:
            return DeleteOutboundportRequest(
                subnets = [
                    ''
                    ]
            )
    ...
    def testDeleteOutboundportRequest(self):
        """Test DeleteOutboundportRequest"""
