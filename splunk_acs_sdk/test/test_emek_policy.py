...
from openapi_client.models.emek_policy import EmekPolicy

class TestEmekPolicy(unittest.TestCase):
    """EmekPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmekPolicy:
        """Test EmekPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmekPolicy`
        """
        model = EmekPolicy()
        if include_optional:
            return EmekPolicy(
