...
from openapi_client.models.roles_response import RolesResponse
...
class TestRolesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RolesResponse:
        """Test RolesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RolesResponse`
        """
        model = RolesResponse()
        if include_optional:
            return RolesResponse(
                ...
                srch_time_win = 56,
                cumulative_rt_srch_jobs_quota = 56,
                cumulative_srch_jobs_quota = 56,
                default_app = '',
                imported = None,
                name = ''
            )
