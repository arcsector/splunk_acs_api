...
from openapi_client.models.stack_status_infrastructure import StackStatusInfrastructure

class TestStackStatusInfrastructure(unittest.TestCase):
    """StackStatusInfrastructure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StackStatusInfrastructure:
        """Test StackStatusInfrastructure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StackStatusInfrastructure`
        """
        model = StackStatusInfrastructure()
        if include_optional:
            return StackStatusInfrastructure(
                stack_type = '',
                stack_version = '',
                status = ''
            )
    ...
    def testStackStatusInfrastructure(self):
        """Test StackStatusInfrastructure"""
