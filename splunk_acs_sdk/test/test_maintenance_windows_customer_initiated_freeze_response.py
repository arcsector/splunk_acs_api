...
from openapi_client.models.maintenance_windows_customer_initiated_freeze_response import MaintenanceWindowsCustomerInitiatedFreezeResponse

class TestMaintenanceWindowsCustomerInitiatedFreezeResponse(unittest.TestCase):
    """MaintenanceWindowsCustomerInitiatedFreezeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaintenanceWindowsCustomerInitiatedFreezeResponse:
        """Test MaintenanceWindowsCustomerInitiatedFreezeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaintenanceWindowsCustomerInitiatedFreezeResponse`
        """
        model = MaintenanceWindowsCustomerInitiatedFreezeResponse()
        if include_optional:
            return MaintenanceWindowsCustomerInitiatedFreezeResponse(
    ...
    def testMaintenanceWindowsCustomerInitiatedFreezeResponse(self):
        """Test MaintenanceWindowsCustomerInitiatedFreezeResponse"""
