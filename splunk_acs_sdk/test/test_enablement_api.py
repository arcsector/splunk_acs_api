...
from openapi_client.api.enablement_api import EnablementApi


class TestEnablementApi(unittest.TestCase):
    """EnablementApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EnablementApi()

    def tearDown(self) -> None:
        pass

    def test_describe_app_feature_enablement(self) -> None:
        """Test case for describe_app_feature_enablement

        """
        pass

    def test_set_app_feature_enablement(self) -> None:
        """Test case for set_app_feature_enablement
