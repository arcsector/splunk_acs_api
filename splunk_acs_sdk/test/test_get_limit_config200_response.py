...
from openapi_client.models.get_limit_config200_response import GetLimitConfig200Response

class TestGetLimitConfig200Response(unittest.TestCase):
    """GetLimitConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLimitConfig200Response:
        """Test GetLimitConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLimitConfig200Response`
        """
        model = GetLimitConfig200Response()
        if include_optional:
            return GetLimitConfig200Response(
                limitconfiguration = openapi_client.models.limit_configuration_response.LimitConfigurationResponse(
                    settings = [
                        ''
                        ], )
            )
    ...
    def testGetLimitConfig200Response(self):
        """Test GetLimitConfig200Response"""
