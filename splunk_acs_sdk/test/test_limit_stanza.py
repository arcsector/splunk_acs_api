...
from openapi_client.models.limit_stanza import LimitStanza

class TestLimitStanza(unittest.TestCase):
    """LimitStanza unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitStanza:
        """Test LimitStanza
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitStanza`
        """
        model = LimitStanza()
        if include_optional:
            return LimitStanza(
                settings = [
                    openapi_client.models.limit_setting.LimitSetting(
                        default_value = 1.337, 
                        max_value = 1.337, 
                        min_value = 1.337, 
                        setting = '', )
