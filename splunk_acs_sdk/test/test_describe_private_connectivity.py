...
from openapi_client.models.describe_private_connectivity import DescribePrivateConnectivity

class TestDescribePrivateConnectivity(unittest.TestCase):
    """DescribePrivateConnectivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribePrivateConnectivity:
        """Test DescribePrivateConnectivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribePrivateConnectivity`
        """
        model = DescribePrivateConnectivity()
        if include_optional:
            return DescribePrivateConnectivity(
                endpoints = [
                    openapi_client.models.private_connectivity_endpoints.PrivateConnectivityEndpoints(
    ...
    def testDescribePrivateConnectivity(self):
        """Test DescribePrivateConnectivity"""
