...
from openapi_client.models.private_connectivity_endpoints import PrivateConnectivityEndpoints

class TestPrivateConnectivityEndpoints(unittest.TestCase):
    """PrivateConnectivityEndpoints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateConnectivityEndpoints:
        """Test PrivateConnectivityEndpoints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateConnectivityEndpoints`
        """
        model = PrivateConnectivityEndpoints()
        if include_optional:
            return PrivateConnectivityEndpoints(
    ...
    def testPrivateConnectivityEndpoints(self):
        """Test PrivateConnectivityEndpoints"""
