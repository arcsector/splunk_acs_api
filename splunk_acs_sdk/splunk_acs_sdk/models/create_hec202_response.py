...
class CreateHEC202Response(BaseModel):
    """
    CreateHEC202Response
    """ # noqa: E501
    http_event_collector: Optional[HecSpec] = Field(default=None, alias="http-event-collector")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "http-event-collector": HecSpec.from_dict(obj["http-event-collector"]) if obj.get("http-event-collector") is not None else None
        })
        return _obj
