...
class AddOutboundportsRequest(BaseModel):
    """
    AddOutboundportsRequest
    """ # noqa: E501
    outbound_ports: Optional[List[AddOutboundportsRequestOutboundPortsInner]] = Field(default=None, alias="outboundPorts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outboundPorts": [AddOutboundportsRequestOutboundPortsInner.from_dict(_item) for _item in obj["outboundPorts"]] if obj.get("outboundPorts") is not None else None,
