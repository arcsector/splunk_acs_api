...
class MaintenanceWindowsCustomerInitiatedFreezeResponse(BaseModel):
    """
    ...
    tickets: List[StrictStr] = Field(description="SFDC Tickets associated with the change freeze request.")
    __properties: ClassVar[List[str]] = ["appliesTo", "createdTimestamp", "endDate", "id", "lastModifiedTimestamp", "reason", "startDate", "tickets"]
