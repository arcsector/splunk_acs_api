...
class CreateOutboundPortsV6Request(BaseModel):
    """
    CreateOutboundPortsV6Request
    """ # noqa: E501
    outbound_ports: Optional[List[CreateOutboundPortsV6RequestOutboundPortsInner]] = Field(default=None, alias="outboundPorts")
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["outboundPorts", "reason"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in outbound_ports (list)
        _items = []
        if self.outbound_ports:
            for _item_outbound_ports in self.outbound_ports:
                if _item_outbound_ports:
                    _items.append(_item_outbound_ports.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outboundPorts": [CreateOutboundPortsV6RequestOutboundPortsInner.from_dict(_item) for _item in obj["outboundPorts"]] if obj.get("outboundPorts") is not None else None,
