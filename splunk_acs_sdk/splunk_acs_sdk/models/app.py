...
class App(BaseModel):
    ...
    splunkbase_id: Optional[StrictStr] = Field(default=None, alias="splunkbaseID")
    state_change_requires_restart: Optional[StrictBool] = Field(default=None, alias="stateChangeRequiresRestart")
    status: StrictStr
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["appID", "label", "name", "package", "splunkbaseID", "stateChangeRequiresRestart", "status", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "splunkbaseID": obj.get("splunkbaseID"),
            "stateChangeRequiresRestart": obj.get("stateChangeRequiresRestart"),
