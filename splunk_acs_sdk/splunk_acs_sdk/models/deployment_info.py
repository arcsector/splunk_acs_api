...
class DeploymentInfo(BaseModel):
    ...
    DeploymentInfo
    """ # noqa: E501
    id: StrictStr = Field(description="the id of the latest deployment task")
    status: Optional[StrictStr] = Field(default=None, description="the status of the last deployment task, possible values are new, completed, pending, running, failed.")
    timestamp: Optional[StrictStr] = Field(default=None, description="timestamp of the latest deployment task")
    __properties: ClassVar[List[str]] = ["id", "status", "timestamp"]
