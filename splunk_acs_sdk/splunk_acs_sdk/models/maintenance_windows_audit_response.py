...
class MaintenanceWindowsAuditResponse(BaseModel):
    """
    MaintenanceWindowsAuditResponse
    """ # noqa: E501
    audits: List[MaintenanceWindowsSchedule]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audits": [MaintenanceWindowsSchedule.from_dict(_item) for _item in obj["audits"]] if obj.get("audits") is not None else None
        })
        return _obj
