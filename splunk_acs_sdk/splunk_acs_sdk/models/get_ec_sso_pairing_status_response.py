...
class GetEcSsoPairingStatusResponse(BaseModel):
    """
    Status for pairing Splunk Cloud stack with Observability organization
    """ # noqa: E501
    pairing_id: Optional[StrictStr] = Field(default=None, alias="pairingId")
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["pairingId", "status"]
