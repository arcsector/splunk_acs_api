...
class DescribeAllowlistV6200Response(BaseModel):
    """
    DescribeAllowlistV6200Response
    """ # noqa: E501
    subnets: Optional[List[StrictStr]] = Field(default=None, description="the ipv6 subnets from where the stack feature is accessible from")
