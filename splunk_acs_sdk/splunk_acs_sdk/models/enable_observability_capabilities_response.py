...
class EnableObservabilityCapabilitiesResponse(BaseModel):
    """
    CO2 spec value of the o11y key
    """ # noqa: E501
    centralized_rbac_enabled: Optional[StrictBool] = Field(default=None, alias="centralizedRBACEnabled")
    __properties: ClassVar[List[str]] = ["centralizedRBACEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "centralizedRBACEnabled": obj.get("centralizedRBACEnabled")
        })
        return _obj
