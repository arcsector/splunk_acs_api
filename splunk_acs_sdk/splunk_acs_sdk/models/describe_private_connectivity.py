...
class DescribePrivateConnectivity(BaseModel):
    """
    DescribePrivateConnectivity
    """ # noqa: E501
    endpoints: Optional[List[PrivateConnectivityEndpoints]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoints": [PrivateConnectivityEndpoints.from_dict(_item) for _item in obj["endpoints"]] if obj.get("endpoints") is not None else None
        })
        return _obj
