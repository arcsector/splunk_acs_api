...
class StackStatus(BaseModel):
    ...
    StackStatus
    """ # noqa: E501
    infrastructure: StackStatusInfrastructure
    messages: StackStatusMessages
    __properties: ClassVar[List[str]] = ["infrastructure", "messages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "infrastructure": StackStatusInfrastructure.from_dict(obj["infrastructure"]) if obj.get("infrastructure") is not None else None,
            "messages": StackStatusMessages.from_dict(obj["messages"]) if obj.get("messages") is not None else None
        })
        return _obj
