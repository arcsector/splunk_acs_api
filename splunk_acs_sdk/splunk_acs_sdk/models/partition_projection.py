...
class PartitionProjection(BaseModel):
    """
    PartitionProjection
    """ # noqa: E501
    account_id_key_name: Optional[StrictStr] = Field(default=None, alias="accountIDKeyName")
    account_ids: Annotated[List[StrictStr], Field(min_length=1)] = Field(alias="accountIDs")
    region_key_name: Optional[StrictStr] = Field(default=None, alias="regionKeyName")
    regions: Annotated[List[StrictStr], Field(min_length=1)]
    time_key_name: Optional[StrictStr] = Field(default=None, alias="timeKeyName")
    time_range: Optional[StrictStr] = Field(default=None, alias="timeRange")
    time_unit: Optional[StrictStr] = Field(default=None, alias="timeUnit")
    __properties: ClassVar[List[str]] = ["accountIDKeyName", "accountIDs", "regionKeyName", "regions", "timeKeyName", "timeRange", "timeUnit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountIDKeyName": obj.get("accountIDKeyName"),
            "accountIDs": obj.get("accountIDs"),
            "regionKeyName": obj.get("regionKeyName"),
            "regions": obj.get("regions"),
            "timeKeyName": obj.get("timeKeyName"),
