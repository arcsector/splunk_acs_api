...
class HecInfo(BaseModel):
    """
    HecInfo
    """ # noqa: E501
    spec: Optional[HecSpec] = None
    token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["spec", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spec": HecSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "token": obj.get("token")
        })
        return _obj
