...
class OutboundResponse(BaseModel):
    ...
    OutboundResponse
    """ # noqa: E501
    destination_ranges: Optional[List[StrictStr]] = Field(default=None, alias="destinationRanges")
    name: Optional[StrictStr] = None
    port: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["destinationRanges", "name", "port"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destinationRanges": obj.get("destinationRanges"),
            "name": obj.get("name"),
            "port": obj.get("port")
        })
        return _obj
