...
class ListSelfStorageLocations200Response(BaseModel):
    """
    ListSelfStorageLocations200Response
    """ # noqa: E501
    self_storage_locations: List[SelfStorageLocationInfo] = Field(alias="selfStorageLocations")
    __properties: ClassVar[List[str]] = ["selfStorageLocations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in self_storage_locations (list)
        _items = []
        if self.self_storage_locations:
            for _item_self_storage_locations in self.self_storage_locations:
                if _item_self_storage_locations:
                    _items.append(_item_self_storage_locations.to_dict())
            _dict['selfStorageLocations'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selfStorageLocations": [SelfStorageLocationInfo.from_dict(_item) for _item in obj["selfStorageLocations"]] if obj.get("selfStorageLocations") is not None else None
        })
        return _obj
