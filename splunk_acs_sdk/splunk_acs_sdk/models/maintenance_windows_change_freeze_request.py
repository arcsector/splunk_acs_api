...
class MaintenanceWindowsChangeFreezeRequest(BaseModel):
    """
    MaintenanceWindowsChangeFreezeRequest
    """ # noqa: E501
    customer_initiated_freezes: List[MaintenanceWindowsCustomerInitiatedFreezeRequest] = Field(alias="customerInitiatedFreezes")
    __properties: ClassVar[List[str]] = ["customerInitiatedFreezes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customerInitiatedFreezes": [MaintenanceWindowsCustomerInitiatedFreezeRequest.from_dict(_item) for _item in obj["customerInitiatedFreezes"]] if obj.get("customerInitiatedFreezes") is not None else None
        })
        return _obj
