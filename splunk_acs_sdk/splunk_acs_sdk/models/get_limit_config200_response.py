...
class GetLimitConfig200Response(BaseModel):
    """
    GetLimitConfig200Response
    """ # noqa: E501
    limitconfiguration: Optional[LimitConfigurationResponse] = None
    __properties: ClassVar[List[str]] = ["limitconfiguration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of limitconfiguration
        if self.limitconfiguration:
            _dict['limitconfiguration'] = self.limitconfiguration.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "limitconfiguration": LimitConfigurationResponse.from_dict(obj["limitconfiguration"]) if obj.get("limitconfiguration") is not None else None
        })
        return _obj
