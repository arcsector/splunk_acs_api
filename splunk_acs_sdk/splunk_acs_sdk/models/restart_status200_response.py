...
class RestartStatus200Response(BaseModel):
    """
    RestartStatus200Response
    """ # noqa: E501
    shc_status: Optional[List[RestartStatus]] = Field(default=None, alias="shcStatus")
    __properties: ClassVar[List[str]] = ["shcStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in shc_status (list)
        _items = []
        if self.shc_status:
            for _item_shc_status in self.shc_status:
                if _item_shc_status:
                    _items.append(_item_shc_status.to_dict())
            _dict['shcStatus'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shcStatus": [RestartStatus.from_dict(_item) for _item in obj["shcStatus"]] if obj.get("shcStatus") is not None else None
        })
        return _obj
