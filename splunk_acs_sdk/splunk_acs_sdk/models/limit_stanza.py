...
class LimitStanza(BaseModel):
    """
    LimitStanza
    """ # noqa: E501
    settings: Optional[List[LimitSetting]] = None
    stanza: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["settings", "stanza"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [LimitSetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None,
