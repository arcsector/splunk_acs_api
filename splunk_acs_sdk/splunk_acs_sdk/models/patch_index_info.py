...
class PatchIndexInfo(BaseModel):
    """
    PatchIndexInfo
    """ # noqa: E501
    max_data_size_mb: Optional[StrictInt] = Field(default=None, alias="maxDataSizeMB")
    searchable_days: Optional[StrictInt] = Field(default=None, alias="searchableDays")
    ...
    __properties: ClassVar[List[str]] = ["maxDataSizeMB", "searchableDays", "selfStorageBucketPath", "splunkArchivalRetentionDays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxDataSizeMB": obj.get("maxDataSizeMB"),
            "searchableDays": obj.get("searchableDays"),
