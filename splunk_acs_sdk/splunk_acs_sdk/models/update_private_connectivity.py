...
class UpdatePrivateConnectivity(BaseModel):
    """
    UpdatePrivateConnectivity
    """ # noqa: E501
    feature: Optional[List[StrictStr]] = None
    patched_customer_account_ids: Optional[List[StrictStr]] = Field(default=None, alias="patchedCustomerAccountIds")
    __properties: ClassVar[List[str]] = ["feature", "patchedCustomerAccountIds"]
    ...
    def feature_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['ingest', 'search']):
                raise ValueError("each list item must be one of ('ingest', 'search')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patchedCustomerAccountIds": obj.get("patchedCustomerAccountIds")
        })
        return _obj
