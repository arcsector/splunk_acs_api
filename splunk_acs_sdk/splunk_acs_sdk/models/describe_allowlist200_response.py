...
class DescribeAllowlist200Response(BaseModel):
    """
    DescribeAllowlist200Response
    """ # noqa: E501
    subnets: Optional[List[StrictStr]] = Field(default=None, description="the subnets from where the stack feature is accessible from")
    __properties: ClassVar[List[str]] = ["subnets"]
