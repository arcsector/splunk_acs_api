...
class AslProviderProperties(BaseModel):
    """
    AslProviderProperties
    """ # noqa: E501
    local_database: StrictStr = Field(alias="localDatabase")
    remote_database: StrictStr = Field(alias="remoteDatabase")
    remote_tables: List[StrictStr] = Field(alias="remoteTables")
    resource_share_arn: StrictStr = Field(alias="resourceShareArn")
    resource_share_name: StrictStr = Field(alias="resourceShareName")
    __properties: ClassVar[List[str]] = ["localDatabase", "remoteDatabase", "remoteTables", "resourceShareArn", "resourceShareName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "localDatabase": obj.get("localDatabase"),
            "remoteDatabase": obj.get("remoteDatabase"),
            "remoteTables": obj.get("remoteTables"),
            "resourceShareArn": obj.get("resourceShareArn"),
            "resourceShareName": obj.get("resourceShareName")
        })
        return _obj
