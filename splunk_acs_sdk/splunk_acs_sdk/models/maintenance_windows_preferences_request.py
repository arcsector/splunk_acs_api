...
class MaintenanceWindowsPreferencesRequest(BaseModel):
    """
    MaintenanceWindowsPreferencesRequest
    """ # noqa: E501
    change_freezes: MaintenanceWindowsChangeFreezeRequest = Field(alias="changeFreezes")
    record_version: Optional[StrictInt] = Field(default=None, description="Version of the record.", alias="recordVersion")
    __properties: ClassVar[List[str]] = ["changeFreezes", "recordVersion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of change_freezes
        if self.change_freezes:
            _dict['changeFreezes'] = self.change_freezes.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changeFreezes": MaintenanceWindowsChangeFreezeRequest.from_dict(obj["changeFreezes"]) if obj.get("changeFreezes") is not None else None,
