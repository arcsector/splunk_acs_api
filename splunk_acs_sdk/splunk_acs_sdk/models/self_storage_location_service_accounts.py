...
class SelfStorageLocationServiceAccounts(BaseModel):
    """
    SelfStorageLocationServiceAccounts
    """ # noqa: E501
    cluster_master: StrictStr = Field(alias="clusterMaster")
    indexer: StrictStr
    __properties: ClassVar[List[str]] = ["clusterMaster", "indexer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusterMaster": obj.get("clusterMaster"),
