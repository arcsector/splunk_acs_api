...
class StackStatusMessages(BaseModel):
    """
    StackStatusMessages
    """ # noqa: E501
    restart_required: Optional[StrictBool] = Field(default=None, description="The stack has a notification to restart splunk server. User should restart stack via UI for all configurations to be completed. It may take some time for the correct state for restart-required field to be populated in a Search Head Cluster, given sync delays with different Search Heads", alias="restartRequired")
    __properties: ClassVar[List[str]] = ["restartRequired"]
