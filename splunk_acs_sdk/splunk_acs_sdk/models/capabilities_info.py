...
class CapabilitiesInfo(BaseModel):
    ...
    capabilities list
    """ # noqa: E501
    grantable_capabilities: Optional[List[StrictStr]] = Field(default=None, alias="grantableCapabilities")
    system_capabilities: Optional[List[StrictStr]] = Field(default=None, alias="systemCapabilities")
    __properties: ClassVar[List[str]] = ["grantableCapabilities", "systemCapabilities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "grantableCapabilities": obj.get("grantableCapabilities"),
