...
class ImportedRolesInfo(BaseModel):
    """
    ImportedRolesInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "rtSrchJobsQuota", "srchDiskQuota", "srchFilter", "srchIndexesAllowed", "srchIndexesDefault", "srchJobsQuota", "srchTimeEarliest", "srchTimeWin", "roles"]
