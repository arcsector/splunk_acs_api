...
class IndexResponse(BaseModel):
    ...
    """ # noqa: E501
    datatype: StrictStr
    max_data_size_mb: StrictInt = Field(alias="maxDataSizeMB")
    name: StrictStr
    searchable_days: StrictInt = Field(alias="searchableDays")
    ...
    total_event_count: Optional[StrictStr] = Field(default=None, alias="totalEventCount")
    total_raw_size_mb: Optional[StrictStr] = Field(default=None, alias="totalRawSizeMB")
    __properties: ClassVar[List[str]] = ["datatype", "maxDataSizeMB", "name", "searchableDays", "selfStorageBucketPath", "splunkArchivalRetentionDays", "totalEventCount", "totalRawSizeMB"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalEventCount": obj.get("totalEventCount"),
            "totalRawSizeMB": obj.get("totalRawSizeMB")
        })
        return _obj
