...
class Extra(BaseModel):
    ...
    Extra
    """ # noqa: E501
    column_indexes: Optional[List[StrictInt]] = Field(default=None, alias="columnIndexes")
    org_id: Optional[StrictStr] = Field(default=None, alias="orgID")
    partition_style: Optional[StrictStr] = Field(default=None, alias="partitionStyle")
    __properties: ClassVar[List[str]] = ["columnIndexes", "orgID", "partitionStyle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columnIndexes": obj.get("columnIndexes"),
            "orgID": obj.get("orgID"),
