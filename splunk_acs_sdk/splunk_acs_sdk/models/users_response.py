...
class UsersResponse(BaseModel):
    ...
    default_app: StrictStr = Field(alias="defaultApp")
    default_app_source: StrictStr = Field(alias="defaultAppSource")
    email: StrictStr
    full_name: StrictStr = Field(alias="fullName")
    last_successful_login: Optional[StrictStr] = Field(default=None, alias="lastSuccessfulLogin")
    locked_out: StrictBool = Field(alias="lockedOut")
    name: StrictStr
    roles: List[StrictStr]
    __properties: ClassVar[List[str]] = ["capabilities", "defaultApp", "defaultAppSource", "email", "fullName", "lastSuccessfulLogin", "lockedOut", "name", "roles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultAppSource": obj.get("defaultAppSource"),
            "email": obj.get("email"),
            "fullName": obj.get("fullName"),
            "lastSuccessfulLogin": obj.get("lastSuccessfulLogin"),
            "lockedOut": obj.get("lockedOut"),
            "name": obj.get("name"),
            "roles": obj.get("roles")
        })
        return _obj
