...
class AppPerms(BaseModel):
    """
    App Permissions
    """ # noqa: E501
    name: StrictStr
    perms: AppPermsProperties
    __properties: ClassVar[List[str]] = ["name", "perms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "perms": AppPermsProperties.from_dict(obj["perms"]) if obj.get("perms") is not None else None
        })
        return _obj
