...
class RolesRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "rtSrchJobsQuota", "srchDiskQuota", "srchFilter", "srchIndexesAllowed", "srchIndexesDefault", "srchJobsQuota", "srchTimeEarliest", "srchTimeWin", "cumulativeRTSrchJobsQuota", "cumulativeSrchJobsQuota", "defaultApp", "importedRoles"]
