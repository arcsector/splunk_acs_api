...
class ListPermissionsApps200Response(BaseModel):
    """
    ListPermissionsApps200Response
    """ # noqa: E501
    tokeninfo: Optional[AppPermsList] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tokeninfo
        if self.tokeninfo:
            _dict['tokeninfo'] = self.tokeninfo.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tokeninfo": AppPermsList.from_dict(obj["tokeninfo"]) if obj.get("tokeninfo") is not None else None
        })
        return _obj
