...
class RestartStatus(BaseModel):
    ...
    RestartStatus
    """ # noqa: E501
    captain: Optional[StrictStr] = None
    rolling_restart_initiated: Optional[StrictBool] = Field(default=None, alias="rollingRestartInitiated")
    service_ready: Optional[StrictBool] = Field(default=None, alias="serviceReady")
    __properties: ClassVar[List[str]] = ["captain", "rollingRestartInitiated", "serviceReady"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rollingRestartInitiated": obj.get("rollingRestartInitiated"),
            "serviceReady": obj.get("serviceReady")
        })
        return _obj
