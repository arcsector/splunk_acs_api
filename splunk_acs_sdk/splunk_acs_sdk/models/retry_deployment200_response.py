...
class RetryDeployment200Response(BaseModel):
    """
    RetryDeployment200Response
    """ # noqa: E501
    status: Optional[DeploymentInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": DeploymentInfo.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
