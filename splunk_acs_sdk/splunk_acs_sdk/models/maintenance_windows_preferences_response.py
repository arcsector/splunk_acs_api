...
class MaintenanceWindowsPreferencesResponse(BaseModel):
    """
    MaintenanceWindowsPreferencesResponse
    """ # noqa: E501
    change_freezes: MaintenanceWindowsChangeFreezeResponse = Field(alias="changeFreezes")
    record_version: StrictInt = Field(description="Version of the record.", alias="recordVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changeFreezes": MaintenanceWindowsChangeFreezeResponse.from_dict(obj["changeFreezes"]) if obj.get("changeFreezes") is not None else None,
