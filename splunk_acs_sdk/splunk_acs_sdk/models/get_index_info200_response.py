...
class GetIndexInfo200Response(BaseModel):
    """
    GetIndexInfo200Response
    """ # noqa: E501
    indexinfo: Optional[IndexResponse] = None
    __properties: ClassVar[List[str]] = ["indexinfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of indexinfo
        if self.indexinfo:
            _dict['indexinfo'] = self.indexinfo.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "indexinfo": IndexResponse.from_dict(obj["indexinfo"]) if obj.get("indexinfo") is not None else None
        })
        return _obj
