...
class ListHECs200Response(BaseModel):
    """
    ListHECs200Response
    """ # noqa: E501
    http_event_collectors: Optional[List[HecInfo]] = None
    __properties: ClassVar[List[str]] = ["http_event_collectors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in http_event_collectors (list)
        _items = []
        if self.http_event_collectors:
            for _item_http_event_collectors in self.http_event_collectors:
                if _item_http_event_collectors:
                    _items.append(_item_http_event_collectors.to_dict())
            _dict['http_event_collectors'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "http_event_collectors": [HecInfo.from_dict(_item) for _item in obj["http_event_collectors"]] if obj.get("http_event_collectors") is not None else None
        })
        return _obj
