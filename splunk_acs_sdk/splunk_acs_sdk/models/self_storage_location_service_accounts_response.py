...
class SelfStorageLocationServiceAccountsResponse(BaseModel):
    """
    SelfStorageLocationServiceAccountsResponse
    """ # noqa: E501
    message: StrictStr
    service_accounts: Optional[SelfStorageLocationServiceAccounts] = Field(default=None, alias="serviceAccounts")
    __properties: ClassVar[List[str]] = ["message", "serviceAccounts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of service_accounts
        if self.service_accounts:
            _dict['serviceAccounts'] = self.service_accounts.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serviceAccounts": SelfStorageLocationServiceAccounts.from_dict(obj["serviceAccounts"]) if obj.get("serviceAccounts") is not None else None
        })
        return _obj
