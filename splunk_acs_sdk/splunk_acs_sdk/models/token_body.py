...
class TokenBody(BaseModel):
    ...
    """ # noqa: E501
    audience: StrictStr
    expires_on: Optional[StrictStr] = Field(default='+30d', alias="expiresOn")
    type: Optional[StrictStr] = 'static'
    user: StrictStr
    __properties: ClassVar[List[str]] = ["audience", "expiresOn", "type", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expiresOn": obj.get("expiresOn") if obj.get("expiresOn") is not None else '+30d',
