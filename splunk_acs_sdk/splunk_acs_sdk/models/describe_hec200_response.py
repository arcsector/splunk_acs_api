...
class DescribeHec200Response(BaseModel):
    """
    DescribeHec200Response
    """ # noqa: E501
    http_event_collector: Optional[HecInfo] = Field(default=None, alias="http-event-collector")
    __properties: ClassVar[List[str]] = ["http-event-collector"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of http_event_collector
        if self.http_event_collector:
            _dict['http-event-collector'] = self.http_event_collector.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "http-event-collector": HecInfo.from_dict(obj["http-event-collector"]) if obj.get("http-event-collector") is not None else None
        })
        return _obj
