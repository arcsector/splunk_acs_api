...
class DeploymentStatus(BaseModel):
    ...
    DeploymentStatus
    """ # noqa: E501
    last_deployment: DeploymentInfo = Field(alias="lastDeployment")
    __properties: ClassVar[List[str]] = ["lastDeployment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.last_deployment:
            _dict['lastDeployment'] = self.last_deployment.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lastDeployment": DeploymentInfo.from_dict(obj["lastDeployment"]) if obj.get("lastDeployment") is not None else None
        })
        return _obj
