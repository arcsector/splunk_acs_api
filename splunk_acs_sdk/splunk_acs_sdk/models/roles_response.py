...
class RolesResponse(BaseModel):
    ...
    imported: Optional[ImportedRolesInfo] = None
    name: StrictStr
    __properties: ClassVar[List[str]] = ["capabilities", "rtSrchJobsQuota", "srchDiskQuota", "srchFilter", "srchIndexesAllowed", "srchIndexesDefault", "srchJobsQuota", "srchTimeEarliest", "srchTimeWin", "cumulativeRTSrchJobsQuota", "cumulativeSrchJobsQuota", "defaultApp", "imported", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "imported": ImportedRolesInfo.from_dict(obj["imported"]) if obj.get("imported") is not None else None,
            "name": obj.get("name")
        })
        return _obj
