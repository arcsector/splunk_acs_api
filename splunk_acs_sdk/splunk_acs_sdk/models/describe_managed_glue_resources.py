...
class DescribeManagedGlueResources(BaseModel):
    """
    DescribeManagedGlueResources
    """ # noqa: E501
    managed_glue_resources: Optional[List[ManagedGlueResources]] = Field(default=None, alias="managedGlueResources")
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["managedGlueResources", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in managed_glue_resources (list)
        _items = []
        if self.managed_glue_resources:
            for _item_managed_glue_resources in self.managed_glue_resources:
                if _item_managed_glue_resources:
                    _items.append(_item_managed_glue_resources.to_dict())
            _dict['managedGlueResources'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managedGlueResources": [ManagedGlueResources.from_dict(_item) for _item in obj["managedGlueResources"]] if obj.get("managedGlueResources") is not None else None,
