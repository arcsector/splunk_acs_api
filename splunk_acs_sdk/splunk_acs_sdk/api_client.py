...
from splunk_acs_sdk.api_response import ApiResponse, T as ApiResponseT
import splunk_acs_sdk.models
from splunk_acs_sdk import rest
from splunk_acs_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(splunk_acs_sdk.models, klass)
