...
class PlatformOrchestratorApi:
    ...
    def describe_workflow(
        ...
        workflow_name: Annotated[StrictStr, Field(description="Name/ID of the workflow")],
    ...
    ) -> List[DescribeWorkflowResponseObject]:
        """describe_workflow
        ...
        :type stack: str
        :param workflow_name: Name/ID of the workflow (required)
        ...
        _param = self._describe_workflow_serialize(
            stack=stack,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[DescribeWorkflowResponseObject]",
        }
    ...
    @validate_call
    def describe_workflow_with_http_info(
        self,
        stack: Annotated[StrictStr, Field(description="the stack name")],
        workflow_name: Annotated[StrictStr, Field(description="Name/ID of the workflow")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DescribeWorkflowResponseObject]]:
        """describe_workflow
    ...
    @validate_call
    def describe_workflow_without_preload_content(
        self,
        stack: Annotated[StrictStr, Field(description="the stack name")],
        workflow_name: Annotated[StrictStr, Field(description="Name/ID of the workflow")],
        _request_timeout: Union[
    ...
    def _describe_workflow_serialize(
        self,
        stack,
        workflow_name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{stack}/adminconfig/v2/workflows/{workflowName}',
