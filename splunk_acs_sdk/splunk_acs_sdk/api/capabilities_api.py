...
class CapabilitiesApi:
    ...
    def list_capabilities(
        ...
        grantable_only: Annotated[Optional[StrictBool], Field(description="only show grantable capabilities")] = None,
        ...
        :type stack: str
        :param grantable_only: only show grantable capabilities
        :type grantable_only: bool
    ...
    def _list_capabilities_serialize(
        ...
        if grantable_only is not None:
            
            _query_params.append(('grantableOnly', grantable_only))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{stack}/adminconfig/v2/capabilities',
